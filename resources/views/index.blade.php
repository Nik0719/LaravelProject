    ...
    <div class="hero-slider-section">
        ...
        <div class="hero-slider-active swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                @foreach ($home_banner as $bannerList)
                @php
                    $bannerTitle = $bannerList->title;
                    if(str_word_count($bannerList->title) > 2)
                    {
                        $pos = 2;
                        $words = explode(" ", $bannerTitle);
                        array_splice( $words, $pos, 0, '<br>' );
                        $bannerTitle = join(" ",$words);
                    }
                @endphp
                <div class="hero-single-slider-item swiper-slide">
                    <!-- Hero Slider Image -->
                    <div class="hero-slider-bg">
                        <img src="{{asset('storage/media/banner/'.$bannerList->image)}}" alt="{{$bannerList->title}}">
                    </div>
                    <!-- Hero Slider Content -->
                    <div class="hero-slider-wrapper">
                        <div class="container">
                            <div class="row">
                                <div class="col-auto">
 x                                   <div class="hero-slider-content">
                                        <h4 class="subtitle">Grab the Deal</h4>
                                        <h1 class="title">{!! $bannerTitle !!} </h1>
                                        <a href="{{url(''.$bannerList->btn_link.'')}}" class="btn btn-lg btn-pink">{{$bannerList->btn_txt}} </a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="banner-section section-top-gap-100">
        <div class="banner-wrapper clearfix">
            ...
            @foreach ($homeCategories as $list)
            <a href="{{url('category/'.$list->category_slug)}}">
                <div class="banner-single-item banner-style-7 banner-animation banner-color--green float-left"
                    ...
                    <div class="image">
                        <img class="img-fluid" width="600px" src="{{asset('storage/media/category/'.$list->category_image)}}" alt="{{$list->category_name}}">
                    </div>
                </div>
            </a>
            @endforeach
                    ...
                    <div class="col-12">
                        <div class="section-content-gap">
                            <div class="secton-content">
                                ...
                                <p>Order now to receive exclusive deals & discounts</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="product-slider-default-2rows default-slider-nav-arrow">
                            ...
                            <div class="swiper-container product-default-slider-4grid-2row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach ($homeCategories_product_featured[$list->id] as $productAttr)
                                    @php
                                        $productName = $productAttr->product_name;
                                        if(Str::length($productAttr->product_name)>15){
                                            $productName = substr($productAttr->product_name, 0, 15). '...';
                                        }
                                    @endphp
                                    <div class="product-default-single-item product-color--pink swiper-slide">
                                        <div class="image-box">
                                            <a href="{{url('product/'.$productAttr->product_slug)}}" class="image-link">
                                                <img src="{{asset('storage/media/products/'.$productAttr->product_image)}}" alt="{{$productAttr->product_name}}">
                                            </a>
                                            <div class="tag">
                                                <span>sale</span>
                                            </div>
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="{{url('product/'.$productAttr->product_slug)}}">{{$productName}}</a></h6>
                                            ...
                                            <div class="content-right">
                                                <span class="price"><del>&#8377; {{$homeProduct_attr[$productAttr->id][0]->mrp}}</del> &#8377; {{$homeProduct_attr[$productAttr->id][0]->price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                    ...
                    <div class="col-12">
                        <div class="product-slider-default-1row default-slider-nav-arrow">
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    <!-- Start Product Default Single Item -->
                                    @foreach ($homeCategories_product_promo[$list->id] as $productAttr)
                                    @php
                                        $productName = $productAttr->product_name;
                                        if(Str::length($productAttr->product_name)>15){
                                            $productName = substr($productAttr->product_name, 0, 15). '...';
