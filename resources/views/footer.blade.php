                    ...
                    <div class="row mb-n6">
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--pink" data-aos="fade-up"
                                ...
                                <ul class="footer-nav">
                                    <li><a href="/my-account">Delivery Information</a></li>
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2022 <a href="index.html">ApnaStore</a>. Made with <i
                                        class="fa fa-heart text-danger"></i> by <a href="/index"
                                        target="_blank">ApnaStore</a> </p>
